...
<div class="hero_area">
  ...
  <section class="catagory_section layout_padding">
    ...
    {
        if($_POST['sort']=="preco")
                {   $query = "SELECT * FROM livros WHERE categoria='biografia' ORDER BY preco";
        ...
        if($_POST['sort']=="precoh")
                {   $query = "SELECT * FROM livros WHERE categoria='biografia' ORDER BY preco DESC";
                    $result = mysqli_query ($connection,$query)or die(mysqli_error($connection));
                }
    } 
    else   
            {   $query = "SELECT * FROM livros WHERE categoria='biografia'";
                $result = mysqli_query ($connection,$query)or die(mysqli_error($connection));
            } 
    $i=0;
    echo  '      
